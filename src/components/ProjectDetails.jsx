        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center w-full h-full overflow-hidden backdrop-blur-sm">
            <motion.div className="relative max-w-2xl border shadow-sm rounded-2xl bg-gradient-to-l from-midnight to-navy border-white/10" initial={{ opacity: 0, scale: 0.5 }} animate={{ opacity: 1, scale: 1}}>
                ...
                <div className="p-5">
                    ...
                    <a className="mt-3 inline-flex items-center gap-1 font-medium cursor-pointer hover-animation" href={ href }>View Project <img src="assets/arrow-up.svg" className="size-4" /></a>
                </div>
            </motion.div>
        </div>
    );

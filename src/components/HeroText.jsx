...
const HeroText = () => {
    const words = ["Intelligent", "Predictive", "Automated"]
        ...
        <div className="z-10 mt-20 text-center md:mt-40 md:text-left rounded-3xl bg-clip-text">
            ...
            <div className="flex-col hidden md:flex c-space">
                ...
                <div className="flex flex-col items-start">
                    <motion.p className="text-5xl font-medium text-neutral-300" variants= { variants } initial="hidden" animate="visible" transition= {{ delay: 1.2 }}>
                        A <span className="text-white">Data Scientist</span> <br /> Dedicated to Building
                    </motion.p>
                    ...
                    <motion.p className="text-4xl font-medium text-neutral-300" initial= {{ opacity: 0, x: -50 }} animate= {{ opacity: 1, x: 0 }} transition= {{ delay: 1.8 }}>Systems</motion.p>
                </div>
            </div>
            {/* Mobile View */}
            <div className="flex flex-col space-y-6 md:hidden">
                <div>
                    ...
                    <motion.p className="text-5xl text-neutral-300" initial= {{ opacity: 0, x: -50 }} animate= {{ opacity: 1, x: 0 }} transition= {{ delay: 1.2 }}>Building</motion.p>
                    ...
                    <motion.p className="text-5xl text-neutral-300" initial= {{ opacity: 0, x: -50 }} animate= {{ opacity: 1, x: 0 }} transition= {{ delay: 1.8 }}>Systems</motion.p>
                </div>
            </div>
        </div>
    );

  ...
  return (
    ...
    >
      <span
        ...
        style={{
          WebkitMaskImage:
            "linear-gradient(-75deg, var(--primary) calc(100% + 20%), transparent calc(100% + 30%), var(--primary) calc(100% + 100%))",
        }}
      >
        {children}
      </span>
      <span
        style={{
          ...
          backgroundImage:
            "linear-gradient(-75deg, var(--primary)/10% calc(100% + 20%), var(--primary)/50% calc(100% + 25%), var(--primary)/10% calc(100% + 100%))",
        }}
